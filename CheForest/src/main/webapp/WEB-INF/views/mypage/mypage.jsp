    ...
    <div class="container">
      <div class="profile-info">
        ...
        <div class="profile-details">
          <h1 class="profile-title">사용자닉네임님의 마이페이지</h1>
      ...
      <div class="content-layout">
        ...
        <aside class="sidebar">
          <div class="sidebar-content">
            ...
            <div class="menu-list">
              ...
              <button class="menu-item" data-tab="recipes">
                <span class="menu-icon">👨‍🍳</span>
                <span class="menu-text">내 레시피</span>
              </button>
              <button class="menu-item" data-tab="comments">
                <span class="menu-icon">💬</span>
                <span class="menu-text">내 댓글</span>
              </button>
              <button class="menu-item" data-tab="liked">
              ...
              <div class="card-content">
                <div class="activity-list">
                  <div class="activity-item">
                    <span class="activity-label">이번 달 레시피 작성</span>
                    <span class="activity-badge">3개</span>
                  </div>
                  <div class="activity-item">
                    <span class="activity-label">이번 달 댓글 작성</span>
                    <span class="activity-badge">15개</span>
                  </div>
                  <div class="activity-item">
                    <span class="activity-label">평균 레시피 조회수</span>
                    <span class="activity-badge">518회</span>
                  </div>
                  <div class="activity-item">
                    <span class="activity-label">평균 좋아요 수</span>
                    <span class="activity-badge">77개</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="tab-content" id="tab-recipes">
          <div class="tab-header">
            <h2 class="tab-title">작성한 레시피 (24개)</h2>
            <button class="btn-primary" id="btn-create-recipe">
